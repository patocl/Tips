...
SELECT @sql = @sql +
    '-- Update ' + CAST(@@ROWCOUNT AS NVARCHAR(10)) + ' references in Views' + CHAR(13) +
...
SELECT @sql = @sql +
    '-- Update ' + CAST(@@ROWCOUNT AS NVARCHAR(10)) + ' references in Functions' + CHAR(13) +
...
SELECT @sql = @sql +
    '-- Update ' + CAST(@@ROWCOUNT AS NVARCHAR(10)) + ' references in Stored Procedures' + CHAR(13) +
...
SELECT @sql = @sql +
    '-- Update ' + CAST(@@ROWCOUNT AS NVARCHAR(10)) + ' references in Synonyms' + CHAR(13) +
